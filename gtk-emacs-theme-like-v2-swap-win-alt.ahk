...
;
; <win>b (after swap: physical Alt key)
...
;
; <shift><win>b (after swap: physical Alt key)
...
;
; <win>f (after swap: physical Alt key)
...
;
; <shift><win>f (after swap: physical Alt key)
